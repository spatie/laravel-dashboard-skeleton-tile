...
[![GitHub Tests Action Status](https://github.com/spatie/laravel-dashboard-skeleton-tile/actions/workflows/run-tests.yml/badge.svg)](https://github.com/:vendor/:package_name/actions?query=workflow%3Arun-tests+branch%3Amaster)
